      ...
      <div class="grid-2">
        <div class="card">
          ...
          <form id="patientForm">
            ...
            <div class="field-row">
              <div class="field"><label>Phone</label><input id="p_phone" /></div>
        ...
        <div class="card" id="orderCard" style="display:none;">
          ...
          <div class="hint" style="margin-bottom:10px;">Tick every panel this visit needs, then create the report once — they'll all share a single Report ID.</div>
...
document.getElementById('addTestBtn').addEventListener('click', async () => {
  ...
  try {
    const report = await api('/results', { method: 'POST', body: JSON.stringify({ patientId: currentPatientId, testCatalogIds }) });
